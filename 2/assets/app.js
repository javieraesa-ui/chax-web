...
function initSignalSimulator() {
  ...
  function updateSimulationState() {
    ...
    if (isOffline) {
      ...
      // Actualizar burbujas en App Tradicional
  ...
  // Manejar envío de mensaje simulado interactivo
  function sendMessage() {
    ...
    // Si está offline, responder automáticamente desde el nodo receptor Chax en 1.2 segundos
    if (isOffline) {
      setTimeout(() => {
...
function initDeviceTabs() {
  ...
  const screenshotsData = {
    iphone: [
      { src: "../assets/screenshots/iphone/01_conversaciones.png", caption: "01. Mensajería Instantánea Cifrada" },
      { src: "../assets/screenshots/iphone/02_chat_directo.png", caption: "02. Chat E2EE & Notas de Voz PTT" },
      { src: "../assets/screenshots/iphone/03_mapax.png", caption: "03. Mapax: Mapa Táctico Satelital Offline" },
      { src: "../assets/screenshots/iphone/04_radar_mesh.png", caption: "04. Radar Mesh de Nodos Cercanos" },
      { src: "../assets/screenshots/iphone/05_ajustes_red.png", caption: "05. Identidad Soberana sin Servidor" }
    ],
    ipad: [
      { src: "../assets/screenshots/ipad/01_conversaciones.png", caption: "01. Vista Multipanel iPadOS" },
      { src: "../assets/screenshots/ipad/02_chat_directo.png", caption: "02. Conversación de Alta Definición" },
      { src: "../assets/screenshots/ipad/03_mapax.png", caption: "03. Mapax Táctico en Pantalla Completa" },
      { src: "../assets/screenshots/ipad/04_identidad.png", caption: "04. Radar Mesh y Llaves Soberanas" },
      { src: "../assets/screenshots/ipad/05_ajustes_red.png", caption: "05. Configuración de Red Soberana" }
    ],
    mac: [
      { src: "../assets/screenshots/mac/01_conversaciones.png", caption: "01. Chax Nativo macOS para Escritorio", isMac: true },
      { src: "../assets/screenshots/mac/02_chat_directo.png", caption: "02. Chat E2EE con Soporte de Teclado", isMac: true },
      { src: "../assets/screenshots/mac/03_mapax.png", caption: "03. Mapax: Cartografía Satelital en Mac", isMac: true },
      { src: "../assets/screenshots/mac/04_radar_mesh.png", caption: "04. Radar Mesh de Nodos de Escritorio", isMac: true },
      { src: "../assets/screenshots/mac/05_ajustes_red.png", caption: "05. Ajustes y Bóveda Criptográfica", isMac: true }
    ]
  };
